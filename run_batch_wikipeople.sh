...
# ./run_batch_wikipeople.sh 6 wikipeople statements StarE stare_stats_baseline_well None True
...
do
    option="DEVICE cuda DATASET ${dataset} EVAL_EVERY 10
            ...
            SUBTYPE ${datatype} EPOCHS 501 GCN_ENCODER ${encoder}
            MODEL_NAME ${model} SEED ${seed}
            GCN_SEP_ENT_EMBEDDING False
            GCN_WEIGHT_TRANS True GCN_MASK_EDGE False
            USE_TEST True CLEANED_DATASET False MAX_QPAIRS 7
