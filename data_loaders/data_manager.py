...
class DataManager(object):
    ...
    @staticmethod
    def get_custom_graph_repr(raw: Union[List[List[int]], np.ndarray], config: dict) \
            -> Dict[str, np.ndarray]:
        """
        Decisions:
        ...
        #         temp = new_data_i[1:3]
        #         new_data_i[1:3] = new_data_i[i:i+2]
        #         new_data_i[i:i+2] = temp
